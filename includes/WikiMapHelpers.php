...
class WikiMapHelpers {
	 ...
	 *              fit: [box|extend], in box mode rendered image has to fit inside the box but can have one
	 *                dimension smaller, in extend mode renderer try to fit entire box, even with empty space
	 * @param Parser $parser
	 * @param PPFrame $frame
	 * @return string HTML representation of map
	 */
